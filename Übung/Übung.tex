...
\begin{document}
	%\maketitle
	\thispagestyle{empty}
	\section{Welche der folgenden Graphen sind hamiltonsch?}
	\begin{figure}[H]
		\centering
	...
	\section{Welchen Zusammenhang können Sie zwischen der Hamilton-Eigenschaft und dem Knotengrad erkennen?}
	\begin{figure}[H]
		\centering
		\begin{subfigure}{0.3\linewidth}
			\centering
